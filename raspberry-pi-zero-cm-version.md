...
- **Примечание**: Cтоила $10. Популярна для IoT-проектов. Существует всего одна ревизия 1.1.

## Raspberry Pi Zero 2 W
- **Описание**: Обновлённая Zero W. Использует кристалл процессора BCM2710A1 (тот же что использовался в BCM2837A1 у RPi 3), объединённый в одном корпусе вместе с 512 МБ памяти LPDDR2 SDRAM. Частота процессора понижена до 1 ГГц.  Wi-Fi 2.4GHz IEEE 802.11b/g/n, Bluetooth 4.2, BLE.
...
- **Примечание**: Получила пятикратный прирост проузводительности по сравнению с Zero W. Существует всего одна ревизия 1.0.
